...
import Screen92 from '../components/Screen92';
import Screen274 from '../components/Screen274';
...
import Screen314 from '../components/Screen314';
import Screen330 from '../components/Screen330';
...
import Screen231 from '../components/Screen231';
...
import Screen324 from '../components/Screen324';
import Screen4 from '../components/Screen4';
import Screen40 from '../components/Screen40';
import Screen44 from '../components/Screen44';
import Screen58 from '../components/Screen58';
...
const ScreenRouter: React.FC<ScreenRouterProps> = ({
  ...
  if (screenId === 44) {
    return (
      <Screen44 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }

  if (screenId === 58) {
    return (
      <Screen58 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }

  if (screenId === 76) {
    return (
      <Screen76 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }

  if (screenId === 128) {
    return (
      <Screen128 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
  ...
  if (screenId === 376) {
    return (
      <Screen376 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
  ...
  if (screenId === 92) {
    return (
      <Screen92 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }

  if (screenId === 274) {
    return (
      <Screen274 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
  ...
  if (screenId === 193) {
    return (
      <Screen193 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }

  if (screenId === 194) {
    return (
      <Screen194 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }

  if (screenId === 177) {
    return (
      <Screen177 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
  ...
  if (screenId === 284) {
    return (
      <Screen284 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
  ...
  if (screenId === 257) {
    return (
      <Screen257 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
  ...
  if (screenId === 314) {
    return (
      <Screen314 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }

  if (screenId === 330) {
    return (
      <Screen330 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
  ...
  if (screenId === 231) {
    return (
      <Screen231 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
  ...
  if (screenId === 324) {
    return (
      <Screen324 onGoToScreen={goToScreen} ficha={ficha} onUpdateFicha={onFichaChange} />
    );
  }
