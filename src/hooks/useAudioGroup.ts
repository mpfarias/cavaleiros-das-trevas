...
export const SCREEN_AUDIO_GROUPS: Record<number | string, AudioGroup> = {
  ...
  128: 'map',                   // Orbe Armadilha da Mente no bandido (rota /game/128) - nature-sound-map.mp3
  373: 'map',                   // Oferecer ouro ao bandido - Poço do Feiticeiro (rota /game/373) - nature-sound-map.mp3
  44: 'map',                    // Estrada de Weirtown após eremita (rota /game/44) - nature-sound-map.mp3
  58: 'map',                    // Água mágica do Poço do Feiticeiro (rota /game/58) - nature-sound-map.mp3
  ...
  76: 'eremita',                // Ensinamento de Hammicus (rota /game/76) - bgm-eremita.mp3
  ...
  376: 'dramatic',              // Corpo desaparece após Mulher Sorridente (rota /game/376) - bgm-dramatic.mp3
