      ...
      <CardWrap>
        <CardContent sx={{ padding: '40px' }}>
          <NarrativeText>
            ...
            <br /><br />
            — Foi uma sorte encontrá-lo aqui, mercenário. Sem a sua ajuda, este confronto teria terminado de forma bem diferente. Sei que você tem uma grande dívida a pagar. Como recompensa, ofereço este Documento de Perdão Cívico. A partir de agora, você não deve mais nada à Cidade.
            <br /><br />
