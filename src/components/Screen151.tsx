      ...
      <CardWrap>
        <CardContent sx={{ padding: '40px' }}>
          <NarrativeText>
            ...
            <br /><br />
            Desta vez, ele balança os dados com um ar de desafio:
            <br /><br />
            — As regras são quase as mesmas, mas agora basta tirar 3 ou mais para vencer. Que tal? Vai encarar?
          </NarrativeText>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px', marginTop: '16px' }}>
            <ChoiceButton onClick={() => onGoToScreen(94)}>
              Jogar novamente?
            </ChoiceButton>
