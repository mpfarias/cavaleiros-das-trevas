...
const Screen40: React.FC<Screen40Props> = ({ onGoToScreen, ficha, onUpdateFicha }) => {
  const { currentGroup, isPlaying, togglePlay } = useAudioGroup(40);
  ...
  useEffect(() => {
    if (!itemAdded) {
      const chavePreta: Item = {
        id: 'chave-preta',
        nome: 'Chave Preta',
        tipo: 'equipamento',
        quantidade: 1,
        descricao: 'Uma pequena chave preta encontrada no corpo do Homem-Orc'
      };

      const fichaAtualizada: Ficha = {
        ...ficha,
        bolsa: [...ficha.bolsa, chavePreta]
      };
    ...
    <Container data-screen="screen-40">
      ...
      <CardWrap>
        <CardContent sx={{ padding: '40px' }}>
          <NarrativeText>
            Embora o Homem-Orc tenha lutado com bravura, a verdade é que você o derrotou.
            <br/><br/>
            Essas criaturas normalmente vivem em regiões desérticas — se ele estava aqui, certamente era por uma grande recompensa... ou por medo de um castigo terrível.
            <br/><br/>
