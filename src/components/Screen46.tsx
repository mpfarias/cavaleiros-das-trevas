...
interface Screen46Props {
  onGoToScreen: (screenId: number) => void;
  ficha: any;
  onUpdateFicha: (ficha: any) => void;
}

const Screen46: React.FC<Screen46Props> = ({ onGoToScreen, ficha, onUpdateFicha }) => {
  ...
  useEffect(() => {
    const initializeBattleAudio = async () => {
      try {
        ...
        console.warn('🎵 [Screen46] Erro ao inicializar áudio de batalha:', error);
      }
    };
  ...
  return (
    <>
      ...
      <Container data-screen="screen-46">
        <CardWrap>
        <CardContent sx={{ padding: '40px' }}>
          {battleState === 'intro' && (
            <>
              <NarrativeText>
                O soldado te alcança rapidamente.
                <br/><br/>
                Por mais que isso te desagrade, você terá que matá-lo antes que cheguem reforços.
                <br/><br/>
                <strong>GUARDA — PERÍCIA {enemy.pericia} | FORÇA {enemy.forca}</strong>
                <br/><br/>
                <Box component="span" sx={{ 
                  ...
                  ⚠️ ATENÇÃO: Você tem apenas 5 turnos para derrotar o guarda! Se não conseguir, será capturado e levado à prisão!
                </Box>
              </NarrativeText>
          ...
          {battleState === 'victory' && (
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: '16px', animation: `${fadeIn} 0.5s ease-out` }}>
              ...
              <Typography variant="body1" sx={{ 
                ...
                Você derrotou o guarda a tempo! Agora precisa decidir seu próximo movimento antes que mais guardas apareçam.
              </Typography>
      ...
      >
        ...
        <DialogContent sx={{ padding: '24px' }}>
          ...
          <Typography variant="body2" sx={{ 
            ...
            <br/>
            • Quem tiver o maior total causa 2 pontos de dano na FORÇA do oponente
            <br/>
            • Em caso de empate, ambos se defendem e ninguém sofre dano
            <br/>
            • Após cada turno, você pode testar sua SORTE para modificar o dano
            <br/>
